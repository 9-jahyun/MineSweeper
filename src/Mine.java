...
public class Mine {
    ...
    void insertMine(int a, int b) { //insertMine
    ...
    void open(int a, int b, JButton[][] button, Frame frame, Timer timer) {
        ...
        if (mineBoard[a][b] == 0) {
            ...
            switch(mineBoard[a][b]) {
                case 1 : button[a][b].setIcon(new ImageIcon("pic/1.png")); break;
                case 2 : button[a][b].setIcon(new ImageIcon("pic/2.png")); break;
                case 3 : button[a][b].setIcon(new ImageIcon("pic/3.png")); break;
                case 4 : button[a][b].setIcon(new ImageIcon("pic/4.png")); break;
                case 5 : button[a][b].setIcon(new ImageIcon("pic/5.png")); break;
                case 6 : button[a][b].setIcon(new ImageIcon("pic/6.png")); break;
                case 7 : button[a][b].setIcon(new ImageIcon("pic/7.png")); break;
                case 8 : button[a][b].setIcon(new ImageIcon("pic/8.png")); break;
            }
            emptyNum--;
        }
        if(emptyNum == 0) {
